...
def run():
    ...
    with col1:
        ...
        with st.container(border=True):
            ...
            mbti =  st.selectbox("Myers-Briggs Type Indicator (MBTI) personality types", ('ISTJ', 'ISFJ', 'INTJ', 'INFJ', 'ISTP', 'ISFP', 'INFP', 'INTP', 'ESTP', 'ESFP', 'ENFP', 'ENTP', 'ESTJ', 'ESFJ', 'ENFJ', 'ENTJ'), index=None, placeholder='Choose an option')
